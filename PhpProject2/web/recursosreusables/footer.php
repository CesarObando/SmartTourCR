                ...
                <div class="footer-grids">
                    <div class="col-md-3 footer-nav wow fadeInLeft animated" data-wow-delay=".5s">
                        ...
                        <ul>
                            ...
                            <li><a href="gallery1.html">Galeria 2014</a></li>
                    ...
                    <div class="col-md-5 footer-nav wow fadeInUp animated" data-wow-delay=".5s">
                        <h4>Boletin</h4>
                        <p>Reciba noticias relacionadas a promociones y ofertas</p>
                        <form>
                            <input type="email" id="mc4wp_email" name="EMAIL" placeholder="Ingrese su correo electronico aqui" required="">
